    ...
    public class D_Container_SO : DisplayDataBase
    {
        ...
        void TryInitializeContainer()
        {
            ...
            else
            {
                ...
                d_value.SetDataPath(refContainer.GetPath());
        ...
        public void RemoveNoneReferenceDisplayDataBases()
        {
            List<DisplayDataBase> displayDataBases = new List<DisplayDataBase>();
            foreach (var x in baseData)
            {
                if (x.GetDataBase().GetReplicateType() == ReplicateType.reference)
                {
                    displayDataBases.Add(x);
                }
            }
            baseData = displayDataBases;
        }
