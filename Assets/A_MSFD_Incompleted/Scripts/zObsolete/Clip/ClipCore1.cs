...
{
    [System.Serializable]
    public class ClipCore1
    {
        public CascadeModifierFloat maxCapacity = new CascadeModifierFloat(1, true);
        public CascadeModifierFloat shootCost = new CascadeModifierFloat(0.2f, true);
        public CascadeModifierFloat reloadPerSec = new CascadeModifierFloat(0.1f, true);
        public CascadeModifierFloat delayBetweenShoot = new CascadeModifierFloat(0.2f, true);
